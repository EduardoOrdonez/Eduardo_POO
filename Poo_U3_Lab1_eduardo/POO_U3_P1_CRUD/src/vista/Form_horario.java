...
public class Form_horario extends javax.swing.JInternalFrame {
    ...
    public Form_horario() {
        ...
        try{
            ...
            while(rs.next()){
                ...
                registro[3]=rs.getString("hor_materia");
                registro[4]=rs.getString("hor_estado");
    ...
    try {
        ...
        String SQL = "INSERT INTO horario (ho_dia, ho_hora,hor_materia, hor_estado) VALUES (?, ?, ?,?)";
    ...
    public void actualizarDatos(){
        ...
        String materia = bnoMateria.getSelectedItem().toString();
        String estado = bnoEstado.getSelectedItem().toString();  
        String SQL = "UPDATE horario SET ho_dia=?, ho_hora=?,hor_materia=?, hor_estado=? WHERE ho_codigo=?"; 
