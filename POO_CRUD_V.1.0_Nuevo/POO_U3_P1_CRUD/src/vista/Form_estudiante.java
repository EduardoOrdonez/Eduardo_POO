...
public class Form_estudiante extends javax.swing.JInternalFrame {
    ...
    public void mostrarDartos(){
        ...
        txtApellidos.setText(tablaEstudiante.getValueAt(filaSeleccionada, 2).toString());
        cboAsignatura.setSelectedItem(tablaEstudiante.getValueAt(filaSeleccionada,3));
        txtPromedio.setText(tablaEstudiante.getValueAt(filaSeleccionada, 4).toString());
        cboEstado.setSelectedItem(tablaEstudiante.getValueAt(filaSeleccionada, 5));
